<template>
  <div class="ml-6 bg-gray-100 p-0.5 rounded-lg items-center">
    <button
      @click="appStore.toggle()"
      type="button"
      :class="[
        { 'shadow-sm bg-white': appStore.listView === 'list' },
    ...
    <button
      ...
      type="button"
      :class="[
        { 'shadow-sm bg-white': appStore.listView === 'grid' },
